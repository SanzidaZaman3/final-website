...
import Image from 'next/image'; // Assuming you're using Next.js, import Image properly
  ...
  return (
    <div className="container pt-6 grid-cols-2">
      ...
      <div className="grid lg:grid-cols-[300px,1fr] gap-4">
        <div className="border border-gray-300 rounded-2xl grid items-center p-6 lg:p-0">
        ...
        <div className="bg-red-600 bg-[url(/banner4.jpg)] bg-cover h-[500px] rounded-2xl
